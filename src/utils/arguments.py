...
def get_args():
    ...
    parser.add_argument('--train_time_steps', type=int, default=1, help="time steps for training")
    ...
    parser.add_argument('--batch_size', type=int, default=32, help="the negative number in the same frame")
...
def get_configuration():
    ...
    if args.training_type == 0:
        ...
        cfg.max_epoch = 30
        cfg.lr = 2e-5  # generator / UNet learning rate
        cfg.lr_tm = 30 # noisy-diffusion timestep MLP learning rate
        cfg.lr_min = 1e-8 # minimum annealed LR
    else:
